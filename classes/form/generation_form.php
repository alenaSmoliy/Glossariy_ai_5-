...
class generation_form extends \moodleform {
    ...
    protected function definition() {
        ...
        $mform->addElement('select', 'terms_count', '📊 ' . get_string('terms_count', 'local_glossary_ai'), [
            10 => '10 ' . get_string('terms', 'local_glossary_ai'),
            25 => '25 ' . get_string('terms', 'local_glossary_ai'),
            50 => '50 ' . get_string('terms', 'local_glossary_ai')
        ]);
        $mform->setDefault('terms_count', 10);
        
        // Language selection with both Russian and English
